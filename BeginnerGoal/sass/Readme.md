...
folder are mapped to the application's root namespace, 'BeginnerGoal'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "BeginnerGoal"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'BeginnerGoal' in the same way
as `"BeginnerGoal/sass/src"`.
